...
export const LogoIcon: React.FC<IconProps> = (props) => (
    ...
    >
        ...
        <path d="M12.5 18a.5.5 0 01-.5.5h-3a.5.5 0 010-1h3a.5.5 0 01.5.5zM12.5 16a.5.5 0 01-.5.5h-5a.5.5 0 010-1h5a.5.5 0 01.5.5zM12.5 14a.5.5 0 01-.5.5h-5a.5.5 0 010-1h5a.5.5 0 01.5.5zM11.5 12a.5.5 0 01-.5.5h-3a.5.5 0 010-1h3a.5.5 0 01.5.5z"></path>
    </svg>
);
